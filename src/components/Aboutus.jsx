      ...
      <div className="about-main">
        <div className="content-section">
          <motion.div
            ...
            animate={{ x: 0 }}
          >
            <h2>Welcome to Vamsi Events</h2>
            <p className="lead-text">
              From weddings and corporate events to concerts and parties, Vamsi Events is dedicated to making your events extraordinary. Join us on a journey of creativity and wonder, and let us transform your visions into reality.</p>
          ...
          >
            ...
            <img
              ...
              alt="Vamsi Events"
            />
            <p className='mt-1'>Founded in 2019, Vamsi Events has been a pioneer in providing exceptional special effects services across India. Our expertise spans a wide range of effects.</p>
            <p>
