    ...
    <div id="about1" className="container">
      ...
      <div className="about-container">
        <div className="about-video">
          <video className="videoPlayer" src="https://res.cloudinary.com/drjmfligo/video/upload/v1719312787/crop2_pxjahe.mp4" autoPlay loop muted></video>
        </div>
      ...
      <div className="about-container reverse">
        ...
        <div className="about-video">
          <video className="videoPlayer" src="https://res.cloudinary.com/drjmfligo/video/upload/v1719312883/vid2org_ph1bdg.mp4" autoPlay loop muted></video>
        </div>
      </div>
    </div>
  );
